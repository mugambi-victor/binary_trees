...
int binary_tree_is_perfect(const binary_tree_t *tree)
{
    ...
    /* Get the height of the left and right subtrees using the existing height-checking function */
    left_height = binary_tree_height(tree->left);
    right_height = binary_tree_height(tree->right);

    /* Check if the left and right subtrees have the same height and are perfect */
